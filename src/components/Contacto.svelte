...
<div class="flex items-center ">
  <div class="flex-grow mx-auto border border-gray-100">
    <div class="max-w-xl mx-auto my-10 bg-white bg-opacity-50 p-5 rounded-md shadow-lg border border-green-800">
